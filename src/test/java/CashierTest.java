...
/**
 * The class <code>CashierTest</code> contains tests for the class <code>{@link Cashier}</code>.
 *
 * @generatedBy CodePro at 3/9/15 8:01 PM
 * @author Mohit
 * @version $Revision: 1.0 $
 */
public class CashierTest {
	/**
	 * Run the Cashier() constructor test.
	 *
	 * @generatedBy CodePro at 3/9/15 8:01 PM
	 */
	@Test
	public void testCashier_1()
		throws Exception {
	...
	public void testMain_1()
		...
		//    java.lang.ClassNotFoundException: Cashier
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(CashierTest.class);
	}
}